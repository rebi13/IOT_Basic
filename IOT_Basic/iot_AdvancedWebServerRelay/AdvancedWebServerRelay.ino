...
String relayWeb = ""
    "<!DOCTYPE html><html><head><title>Relay Web</title></head><body><center>"
    "<p>Advanced Web Relay Server App</p>"
    ...
    "    xhttp.open('GET', '/turnOn', false);"
    "    xhttp.send(''); };"
    "  button2.onclick=function(e) {"
    "    xhttp.open('GET', '/turnOff', false);"
    "    xhttp.send(''); };"
    "</script><p>This is the Relay Web example</p></center></body></html>";
...
void setup_runtime() {
    ...
    webServer.on("/", [](){
        webServer.send(200, "text/html", relayWeb);
    });
