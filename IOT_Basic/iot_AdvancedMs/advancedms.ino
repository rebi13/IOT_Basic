...
"<!DOCTYPE html><html><head><title>LAB1</title></head><body><center>"
"<p>Relay Button</p>"
"<button id='button1' style='width:160px;height:60px'><font size='20'>Switch</font></button>"
"<script>var xhttp=new XMLHttpRequest();"
" button1.onclick=function(e) {"
" xhttp.open('GET', 'http://192.168.0.19/button', false);"
" xhttp.send(''); }"
